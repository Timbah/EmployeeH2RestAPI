...
public class EmployeeRestController {
    ...
    @Operation(summary = "Get a list of all employees", description = "Retrieve a list of all employees")
    ...
    @Operation(summary = "Fetch a single employee", description = "Get a single employee from database")
    @ResponseStatus(HttpStatus.OK)
    ...
    @Operation(summary = "Update a single employee", description = "Update the details of a current employee")
    @ResponseStatus(HttpStatus.OK)
